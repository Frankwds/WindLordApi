...
- Never present tentative design ideas or desired future behavior as settled current-state requirements
...
- Prefer instructions that would still make sense for a project with minimal architecture assumptions and little or no existing code
