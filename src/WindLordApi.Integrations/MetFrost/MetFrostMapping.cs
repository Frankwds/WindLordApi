...
public class MetFrostMappingService : IMetFrostMapping
{
        ...
        IReadOnlyList<MetObservationsData> observationsData)
    {
        ...
        // Convert map to list and keep only observations with at least one wind-speed metric.
        var stationDataList = stationDataMap.Values
            .Where(data =>
                data.WindSpeed.HasValue
                || data.WindGust.HasValue
                || data.WindMinSpeed.HasValue)
            .Select(data =>
            {
                int? direction = null;
                ...
                return new StationData
                {
                    ...
                    WindMinSpeed = data.WindMinSpeed,
                    Direction = direction,
